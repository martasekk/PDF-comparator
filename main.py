...
class PDFComparatorApp(tk.Tk):
    def __init__(self, size):
        ...
        file_menu.add_command(label= "Clear", command= lambda:[self.first_window.clear_pdf(), self.second_window.clear_pdf()])
    ...
    def extract_words_with_positions(self, page):
        ...
        words = [word[4] for word in word_list]
